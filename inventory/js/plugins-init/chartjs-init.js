		...
		if(jQuery('#barChart_1').length > 0 ){
			...
			new Chart(barChart_1, {
				...
				data: {
					...
					labels: ["Xiaomi 12 Lite", "Acer Swift 3", "Apple Magic Keyboard", "ASUS ROG Falchion", 
					"TP-Link Wireles AC1750", "Samsung S22", "Samsung Led TV 55MU6300", "Magic Mouse 2", 
					"Macbook Pro", "Logitech S120", "iMac 2019", "HP LaserJet Pro P1102w", "DBPOWER T29 LCD Mini", 
					"Canon DSLR (EOS)"],
					datasets: [
						{
							label: "Stock",
							data: [80, 230, 80, 70, 290, 75, 18, 68, 23, 50, 243, 100, 100, 20],
